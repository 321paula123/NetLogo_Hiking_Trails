...
globals [
  ...
  percent-happy        ; The percentage of visitors who are able to succdessfully reach their destination in their planned hike time.
]
...
to compute-nearest-patches
  ...
  ifelse count turtles with [outbound? = false] > 0 [
    set percent-happy 100 * count turtles with [happy? = true] / count turtles with [outbound? = false]]
    [set percent-happy 0]
end
...
1251
364
Maximum Time a Visitor has spent hiking (min)
max [turn-around-time] of turtles * 2
1
1
11
...
1209
306
Percentage of Visitors Reaching their Destination
percent-happy
1
1
11
